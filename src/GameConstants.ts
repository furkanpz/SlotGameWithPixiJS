...
export class GameConstants {
    ...
    public static readonly SPIN_SPEED_TURBO: number = 78; 
    public static readonly SPIN_SPEED_SUPER_TURBO: number = 112; 
    public static readonly MIN_SPEED_NORMAL: number = 24;
    public static readonly MIN_SPEED_TURBO: number = 46; 
    public static readonly MIN_SPEED_SUPER_TURBO: number = 67; 
    public static readonly DECELERATION_NORMAL: number = 0.95;
    public static readonly DECELERATION_TURBO: number = 0.88; 
    public static readonly DECELERATION_SUPER_TURBO: number = 0.3; 
    
    public static readonly MOBILE_NORMAL_SPIN_MULT: number = 1.35; 
    public static readonly MOBILE_NORMAL_MIN_MULT: number = 1.10;  
    
    public static readonly MOBILE_GLOBAL_SPIN_MULT: number = 1.10; 
    public static readonly MOBILE_GLOBAL_MIN_MULT: number = 1.05;  
    
    
    public static readonly REEL_START_DELAY_NORMAL: number = 150; 
    public static readonly REEL_START_DELAY_TURBO: number = 90; 
    public static readonly REEL_START_DELAY_SUPER_TURBO: number = 26; 
    public static readonly TURBO_ANIMATOR_DELAY: number = 50; 
    public static readonly TURBO_FINALIZE_DELAY: number = 400; 
    
    
    public static readonly SPIN_SPEED_TURBO_OLD: number = 100; 
    public static readonly MIN_SPEED_TURBO_OLD: number = 60;
    public static readonly DECELERATION_TURBO_OLD: number = 0.8;
    public static readonly REEL_START_DELAY: number = 150; 
    public static readonly TURBO_REEL_START_DELAY: number = 50; 
    ...
    public static readonly SPIN_BUTTON_DELAY_TURBO: number = 300; 
    public static readonly SPIN_BUTTON_DELAY_SUPER_TURBO: number = 100; 
    public static readonly SLOW_ANIMATION_DELAY_NORMAL: number = 3000;
    public static readonly SLOW_ANIMATION_DELAY_TURBO: number = 1500; 
    public static readonly SLOW_ANIMATION_DELAY_SUPER_TURBO: number = 1000; 
    ...
    public static readonly WILD_DELAY_TURBO: number = 200; 
    public static readonly WILD_DELAY_SUPER_TURBO: number = 50; 
    ...
    public static readonly API_URLS = {
        ...
        SYMBOLS: `${runtimeConfig.apiBaseUrl}/symbols`,
        SERVERCHECK: `${runtimeConfig.apiRoot}/ping`,
        SPIN: `${runtimeConfig.apiBaseUrl}/spin`
    } as const;
    ...
    public static readonly FREESPIN = {
        ...
        FREESPIN_START_DELAY_TURBO: 500, 
        FREESPIN_START_DELAY_SUPER_TURBO: 300, 
        FREESPIN_MODE_BACKGROUND_COLOR: 0x1a0d4d, 
        FREESPIN_INTERVAL_NORMAL: 750, 
        FREESPIN_INTERVAL_TURBO: 500,  
        FREESPIN_INTERVAL_SUPER_TURBO: 250,  
        FREESPIN_ANIMATION_DELAY: 1500, 
        OVERLAY_ANIMATION_DURATION: 1500 
    } as const;
    ...
    DELAY_BETWEEN_SPINS_NORMAL: 900, 
    DELAY_BETWEEN_SPINS_TURBO: 250,  
        BUTTON_WIDTH: 60,
        BUTTON_HEIGHT: 40
    } as const;
    ...
    public static readonly WILD_ANIMATION = {
        ...
        MOVE_DELAY_TURBO: 375, 
        MOVE_DELAY_SUPER_TURBO: 250 
    } as const;
    ...
    public static getWildBlinkDuration(turboLevel: number): number {
        switch (turboLevel) {
            ...
            case 1: return Math.round(this.WILD_ANIMATION.BLINK_DURATION_TURBO * 0.75); 
            case 2: return this.WILD_ANIMATION.BLINK_DURATION_TURBO; 
    ...
    public static getWildMoveDuration(turboLevel: number): number {
        switch (turboLevel) {
            ...
            case 1: return Math.round(this.WILD_ANIMATION.MOVE_DURATION_TURBO * 1.25); 
    ...
    public static getWildAnimationSpeed(turboLevel: number): number {
        switch (turboLevel) {
            ...
            case 1: return (this.WILD_ANIMATION_SPEED_NORMAL + this.WILD_ANIMATION_SPEED_TURBO) / 2; 
